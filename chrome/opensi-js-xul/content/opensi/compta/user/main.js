...
function init() {
	try {
  	...
  	var page = "chrome://opensi/content/compta/user/menu.xul?"+ cookie();
    ...
    document.getElementById("login").value = ParamValeur("Utilisateur");
		...
		if (ParamValeur("VTest")=="true") {
			...
			//document.getElementById("imgBand").setAttribute("src", "chrome://opensi/content/design/bandeau-test.jpg");
		}
