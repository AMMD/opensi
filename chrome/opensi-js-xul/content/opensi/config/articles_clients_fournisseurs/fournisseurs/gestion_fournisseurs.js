...
function reinitialiser() {
	try {
		var tree = document.getElementById('liste_fournisseur');
		var rangeCount = tree.view.selection.getRangeCount();
			if (window.confirm("Souhaitez-vous reininitialiser les fournisseurs sélectionnés ? (les fiches fournisseurs seront de nouveaux visibles dans les fiches fournisseurs du dossier)")){
					for (var i=0; i<rangeCount; i++) {
			  		...
			  		tree.view.selection.getRangeAt(i,start,end);
						...
						showMessage("Les fournisseurs sont restaurés");
						init();
			 }
