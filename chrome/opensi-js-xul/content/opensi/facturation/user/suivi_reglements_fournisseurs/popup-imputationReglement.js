...
var aEcheances=new Arbre("Facturation/Suivi_Reglements_Fournisseurs/liste-affectationEcheances.tmpl", "listeEcheances");
...
function init() {
	try {
		...
		if (boucler) {
			var qListePieces = new QueryHttp("Facturation/Suivi_Reglements_Fournisseurs/getListePiecesImputables.tmpl");
...
function reinitialiser() {
	try {
		if (typePiece=="R") {
			var qReglement = new QueryHttp("Facturation/Suivi_Reglements_Fournisseurs/getReglementFournisseur.tmpl");
			...
			var qAvoir = new QueryHttp("Facturation/Suivi_Reglements_Fournisseurs/getAvoirFournisseur.tmpl");
		...
		aEcheances.setParam("Fournisseur_Id", document.getElementById('numFournisseur').value);
	...
	try {
		...
		if (ok) {
			...
			if (isEmpty(listeEcheances)) { showWarning("Veuillez cocher au moins une échéance !"); }
				...
				var qAffecterReglement = new QueryHttp("Facturation/Suivi_Reglements_Fournisseurs/affecterImputationReglement.tmpl");
