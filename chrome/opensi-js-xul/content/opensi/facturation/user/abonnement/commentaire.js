...
function init() {
  try {
		...
		var qCom = new QueryHttp("Facturation/Abonnement/getCommentaire.tmpl");

		qCom.setParam("type", type);
...
function modifierCommentaire() {
  try {
		...
		var qMaj = new QueryHttp("Facturation/Abonnement/modifierCommentaire.tmpl");

		qMaj.setParam("type", type);
