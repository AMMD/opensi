...
function chargerContact() {
	try {
		...
		if (aContacts.isSelected()) {
			...
			document.getElementById('Principal_Fact').checked = (aContacts.getSelectedCellText('ColPrincipal_Fact')=="1");
			document.getElementById('Principal_Liv').checked = (aContacts.getSelectedCellText('ColPrincipal_Liv')=="1");
			document.getElementById('Principal_Envoi').checked = (aContacts.getSelectedCellText('ColPrincipal_Envoi')=="1");
...
function enregistrerContact(mode) {
    ...
    var civilite = document.getElementById('Civilite').value;
		...
		var principal_fact = (document.getElementById('Principal_Fact').checked?"1":"0");
		var principal_liv = (document.getElementById('Principal_Liv').checked?"1":"0");
		var principal_envoi = (document.getElementById('Principal_Envoi').checked?"1":"0");
