...
var aReglements=new Arbre("Facturation/Suivi_Reglements_Clients/liste-affectationReglements.tmpl", "listeReglements");
...
function init() {
	try {
		...
		if (boucler) {
			var qListePieces = new QueryHttp("Facturation/Suivi_Reglements_Clients/getListeRemboursementsImputables.tmpl");
...
function reinitialiser() {
	try {
		var qRemboursement = new QueryHttp("Facturation/Suivi_Reglements_Clients/getRemboursementClient.tmpl");
		...
		aReglements.setParam("Client_Id", document.getElementById('numClient').value);
	...
	try {
		...
		if (ok) {
			...
			if (isEmpty(listeReglements)) { showWarning("Veuillez cocher au moins un règlement !"); }
				...
				var qAffecterRemboursement = new QueryHttp("Facturation/Suivi_Reglements_Clients/affecterImputationRemboursement.tmpl");
