 ...
 * All Rights Reserved.
 *
 * Contributor(s): Gilles Ballini - 2004-01-19
 * The protions added by Gilles Ballini are Copyright (c) 2003 SpeedInfo.fr S.A.R.L.
 * The portions added by Gilles Ballini are included between
 * the tags <added by Gilles Ballini> and </added by Gilles Ballini>
 * All Rights Reserved.
 */
...
function RDFDataSource(uri,callbackFn, callBackParams)
{
  ...
  function(uri,callbackFn)
{
  ...
  if (callbackFn == null){
    ...
    /*<added by Gilles Ballini>*/
    // Unload former datasource to avoid bugs when a dynamic remote datasource is loaded several times :
    RDFService.UnregisterDataSource(this.datasource);
    /*</added by Gilles Ballini>*/
    var ds;
    try {
