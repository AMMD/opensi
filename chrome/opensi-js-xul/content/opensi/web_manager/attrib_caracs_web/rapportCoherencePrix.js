...
function coherencePrix()
{
	try
	{
		document.getElementById("info").value="Vérification des prix en cours....";

		var arbre_rapport=new Arbre("WebManager/GetRDF/verifPrix.tmpl","contenu_rapport");
...
function chargementFini()
{
	try
	{
		...
		else
		{
			...
			document.getElementById("conclusion_test").value+=" les prix web de vos articles";
		}
